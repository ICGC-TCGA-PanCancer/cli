...
class SysConfig(cliff.command.Command):
    ...
    def get_parser(self,prog_name):
        ...
        sysconf_subparser.add_argument("--force",dest='force_config',required=False, default=False)
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if config_path != None:
            ...
            if prev_aws_key.strip() == '' or prev_aws_secret_key.strip() == '' or force_config==True:
            ...
            if prev_pem_key_path.strip()=='' or prev_key_name.strip()=='' or force_config==True:
